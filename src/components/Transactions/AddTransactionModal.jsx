...
export default function AddTransactionModal({ onClose, onSave }) {
    ...
    return (
        <div style={{
            ...
            <div style={{ background: "white", padding: "2rem", borderRadius: "24px", width: "450px", boxShadow: "var(--shadow)" }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem" }}>
                        <div
                            ...
                            style={{
                                ...
                                border: formData.type === 'income' ? "2px solid #38A169" : "1px solid #eee",
                        ...
                        <div
                            ...
                            style={{
                                flex: 1, padding: "1rem", borderRadius: "12px", cursor: "pointer",
                                border: formData.type === 'expense' ? "2px solid #E53E3E" : "1px solid #eee",
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                        <div>
                            <label style={{ display: "block", fontSize: "0.9rem", color: "#666", marginBottom: "0.5rem" }}>Valor (R$)</label>
                            <input
                                type="number"
                                step="0.01"
                                placeholder="0,00"
                                ...
                                style={{ width: "100%", padding: "0.8rem", borderRadius: "8px", border: "1px solid #ddd", fontSize: "1.2rem", fontWeight: "bold" }}
                                autoFocus
                            />
                        </div>

                        <div>
                            <label style={{ display: "block", fontSize: "0.9rem", color: "#666", marginBottom: "0.5rem" }}>Descrição</label>
                            <input
                                type="text"
                        ...
                        <div style={{ display: "flex", gap: "1rem" }}>
                            <div style={{ flex: 1 }}>
                                <label style={{ display: "block", fontSize: "0.9rem", color: "#666", marginBottom: "0.5rem" }}>Categoria</label>
                                <select
                            ...
                            <div style={{ flex: 1 }}>
                                <label style={{ display: "block", fontSize: "0.9rem", color: "#666", marginBottom: "0.5rem" }}>Data</label>
                                <input
                                    type="date"
                                    value={formData.date}
